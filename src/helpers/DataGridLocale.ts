/* 
  This file is used for translating the MUI Data Grid (Table) from English to Bulgarian.
*/
...
export const DataGridLocale = {
  ...
  toolbarFiltersTooltipActive: (count: any) => `${count} активни филтри`,
  ...
  // Column header text
  columnHeaderFiltersTooltipActive: (count: any) => `${count} активни филтри`,
